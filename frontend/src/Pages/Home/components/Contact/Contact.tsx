...
const contacts = [
  ...
  {
    title: 'Email',
    text: 'contato@marisdoces.com.br',
    icon: (
      <svg viewBox="0 0 24 24" width={28} height={28} fill="currentColor" aria-hidden>
...
const schedule = {
  ...
  icon: (
    <svg viewBox="0 0 24 24" width={22} height={22} fill="#c0631d" aria-hidden>
    ...
    <Stack sx={styles.section} id="contact">
      ...
      <Box sx={styles.cards}>
        {contacts.map(contact => (
          <Stack key={contact.title} sx={styles.card}>
            <Box sx={styles.iconBadge}>{contact.icon}</Box>
